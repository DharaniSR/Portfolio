    ...
    return (
        <Box className='navbar'>
            <Box className='logo'>
                ...
                <Box className='name'>
                    <Heading className='navbar-name'>Dharani S R</Heading>
                </Box>
            </Box>
            <Box display={["none", 'none', 'none', 'flex']} className="nav-options">
                ...
                <Box>
                    <Button onClick={()=>{window.open("https://drive.google.com/file/d/1jBa-w_YRCtrqAD7xrFaRw20mwkTO6QhH/view", '_blank')}}><a href={Resume} download="Dharani-Resume"><span>Resume</span></a></Button>
                </Box>
                <Box>
